...
import AddEventForm from "../AdminDsh/AddEventForm"; // Replace with the correct path to AddEventForm
...
const Eventcard = () => {
  ...
  return (
    <div>
      {/* Add Event Popup */}
      {showAddEventPopup && <AddEventForm onClose={() => setShowAddEventPopup(false)} />}
