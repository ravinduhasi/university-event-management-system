...
import MHelpContent from "./MHelpContent";

const MSidebar = ({ setActiveContent }) => {
  ...
  const menuItems = [
    ...
    { label: "Profile", icon: <BiUserCircle />, content: <MProfileContent /> },
    { label: "Help", icon: <BiHelpCircle />, content: <MHelpContent /> },
  ];
